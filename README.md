...
The goal of this library is to adopt the more promising technology of floating-ui instead of popper.js and make it
available in our Angular projects.
...
2a. [MODULE APPROACH] Just import `NgxFloatUiModule` into your module (or root module):
...
you can customise the defaults by passing them to the `forRoot` method:
...
2b. [STANDALONE APPROACH] You simply add into your module `NgxFloatUiModule`:
...
\* **VERY IMPORTANT**: All the "auto" placements can't be used in combo with prevent overflow (as per float-ui specs),
because the two algorythms **would conflict**, ending in infinite repositioning.
