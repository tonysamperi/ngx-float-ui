...
it("should have popper sibling", () => {
    const popperContent: HTMLElement = poppers[0].nativeElement.parentElement.querySelector("popper-floatUi");
    expect(popperContent).not.toBeNull();
});
...
//     await page.waitForSelector(`.float-ui-container`, {
//         visible: false
//     });
...
// });
//
// it("should show popper-floatUi component on right", async () => {
//     await page.waitForSelector(`.float-ui-container`, {
//         visible: false
//     });
//     await page.click(`.popperTarget`);
...
// });
//
// it("should show popper-floatUi component on right after delay", async () => {
//     await page.waitForSelector(`.float-ui-container`, {
//         visible: false
//     });
//     await page.click(`.popperTarget`);
...
//     //  utils.pause(page);
//     await page.waitForSelector(`popper-floatUi`, {
//         visible: false
//     });
//     await page.hover(`.popperTarget`);
//     await page.waitForSelector(`.float-ui-container`, {
