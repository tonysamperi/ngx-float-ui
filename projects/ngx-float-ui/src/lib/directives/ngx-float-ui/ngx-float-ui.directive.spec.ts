import { Component, DebugElement, Input, TemplateRef, ViewEncapsulation } from "@angular/core";
import {ComponentFixture, fakeAsync, TestBed, tick} from "@angular/core/testing";
import {By} from "@angular/platform-browser";
//
import { NgxFloatUiModule, NgxFloatUiDirective, NgxFloatUiPlacements, NgxFloatUiContentComponent } from "ngx-float-ui";
			...
			<div class="pop-demo">
				<article>
					...
					<div class="pop-generic-section">
						...
						<ng-template #myPopperTemplateRefContentz><p class="pop-lucky-font">Popcorn</p></ng-template>
						<img alt="Popcorn box"
							 [src]="popCornBox"
							 [floatUi]="getMyPopperContentz(myPopperContentz, myPopperTemplateRefContentz)"
...
class NgxFloatUiDirectiveTestComponent {
    @Input() mode: 'content' | 'templateRef' | 'text' = 'content';
    ...
    getMyPopperContentz(content: NgxFloatUiContentComponent, templateRef: TemplateRef<unknown>): NgxFloatUiDirective['floatUi'] {
        switch (this.mode) {
            case 'templateRef':
                return templateRef;
            case 'text':
...
for (const mode of ['content', 'templateRef', 'text']) {
